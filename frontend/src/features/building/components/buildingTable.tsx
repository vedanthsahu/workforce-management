  ...
  return (
    <table className="w-full text-sm table-auto">
      ...
      <thead className="text-xs text-gray-500 bg-gray-50 border-b sticky top-0 z-10">
        <tr>
          <th className="px-6 py-4 text-left">Building Code</th>
          <th className="px-6 py-4 text-left">Building Name</th>
          <th className="px-6 py-4 text-left">Site Name</th>
          <th className="px-6 py-4 text-center">Floors</th>
        ...
        {data.length === 0 ? (
          ...
          data.map((building) => (
            <tr key={building.building_id} className="hover:bg-gray-50">
              ...
              {/* FLOORS */}
              <td className="px-6 py-4 text-center">{building.floor_count}</td>

              {/* TOTAL SEATS */}
              <td className="px-6 py-4 text-center">{building.seat_count}</td>

              {/* ACTIVE SEATS */}
              <td className="px-6 py-4 text-center">{building.active_seat_count}</td>

              {/* BOOKABLE SEATS */}
              <td className="px-6 py-4 text-center">{building.bookable_seat_count}</td>
