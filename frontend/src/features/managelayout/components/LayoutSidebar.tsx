...
// //   /** Pass the floor/building/site IDs so quick-action links include them */
...
// //                 <FileIcon />
// //                 <span className="truncate text-indigo-600 max-w-[120px]" title={fileName(layout.layout_file_url)}>
// //                   {fileName(layout.layout_file_url)}
// //                 </span>
// //                 {layout.file_size_bytes && (
// //                   <span className="text-gray-400 text-[10px] flex-shrink-0">
// //                     {fileSizeLabel(layout.file_size_bytes)}
// //                   </span>
// //                 )}
// //                 <a
...
// //               This layout is archived and not available for bookings. Publish a newer version to replace it.
// //             </p>
// //           </div>
// //         </div>
// //       )}
