...
// export default function LayoutStatCards({ layout }: LayoutStatCardsProps) {
//   if (!layout) {
//     // Render skeleton/empty state cards
//     return (
//       <div className="grid grid-cols-4 gap-4">
//         {[0, 1, 2, 3].map((i) => (
//           <div key={i} className="bg-white rounded-xl border border-gray-100 p-4 h-[88px] animate-pulse">
...
//   const total        = layout.total_seats        ?? 0;
//   const configured   = layout.configured_seats   ?? 0;
//   const unconfigured = layout.unconfigured_seats  ?? 0;
//   const nonBookable  = layout.non_bookable_seats  ?? 0;
...
//             <p className={`text-xl font-semibold leading-none ${card.valueColor ?? "text-gray-900"}`}>
//               {card.value}
//               {card.sub && (
