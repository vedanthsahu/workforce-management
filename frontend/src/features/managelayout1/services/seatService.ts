...
// //   const seats = data.items.map((item) => mapApiItemToSeat(item));
...
// //       }
// //     );
// //     // ← forceConfigured = true ensures is_configured is always true after a save
...
//     seat_code:              item.seat_code,
//     seat_name:              item.seat_name ?? "",
//     seat_type:              item.seat_type ?? "STANDARD",
//     status:                 item.status ?? "ACTIVE",
//     is_bookable:            item.is_bookable ?? true,
//     is_reserved:            item.is_reserved ?? false,
//     is_configured:          forceConfigured ? true : (item.is_configured ?? false),
...
//     );
//     // ← forceConfigured = true ensures is_configured is always true after a save
//      console.log("[configureSeat] raw API response:", JSON.stringify(data, null, 2));
//     const mapped= mapApiItemToSeat(data, true);
//     console.log("[configureSeat] mapped seat:", mapped);
//     return mapped;
//   } catch (err: any) {
//     console.error(
//       "[configureSeat] error:",
