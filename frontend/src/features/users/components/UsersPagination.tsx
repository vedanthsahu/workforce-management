...
export default function UsersPagination({ currentPage, totalPages, onPageChange }: PaginationProps) {
          ...
          page < 0 ? (
            ...
            <button
              ...
              className={`px-2.5 py-1 text-xs rounded-md transition ${
                currentPage === page ? "bg-blue-600 text-white" : "border hover:bg-gray-50 text-gray-600"
              }`}
            >
              {page}
            </button>
