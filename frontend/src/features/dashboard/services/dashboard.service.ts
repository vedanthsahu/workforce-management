...
//     floor:       b.floor_name ?? (b.floor_id ? `Floor ${b.floor_id}` : ""),
//     date:        formatBookingDate(b.booking_date),
//     // Preserve ISO date strings for the modify flow
//     // (cast via `any` since dashboard Booking type is leaner than bookings Booking)
//     ...(({ fromDate: b.booking_date, toDate: b.to_date ?? b.booking_date } as any)),
//     startTime:   "9:00 AM",
//     endTime:     "6:00 PM",
//     status:      mapBookingStatus(b.booking_status),
//     isRecurring: false,
//     seatId:      b.seat_code ?? b.seat_id,
//     managerNote: "",
//     // Preserve raw IDs for the modify / amenity-fetch flow
//     ...(b.floor_id ? { floorId: String(b.floor_id) } as any : {}),
//     ...(b.seat_id  ? { seatId2: String(b.seat_id)  } as any : {}),
//   };
// }
...
// // ✅ cancelBooking deliberately removed from this service.
// // Use cancelBooking from @/features/bookings/services/bookings.service instead,
// // which calls the correct POST /{id}/cancel endpoint with an optional reason.
