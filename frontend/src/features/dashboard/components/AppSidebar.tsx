...
//     {isCollapsed ? (
//       // ── Collapsed: avatar click → /profile ──────────────────────────────
//       <button
...
//           "hover:ring-2 hover:ring-indigo-300 transition-all duration-150 active:scale-95",
//         )}
//       >
//         {profile.avatarUrl ? (
//           <img
...
//           initials
//         )}
//         <span className="absolute -bottom-px -right-px w-2.5 h-2.5 rounded-full bg-emerald-400 border-2 border-white" />
//       </button>
//     ) : (
//       // ── Expanded ─────────────────────────────────────────────────────────
//       <>
...
//           onClick={() => router.push("/profile")}
//           className={cn(
//             "flex items-center gap-2 flex-1 min-w-0 rounded-lg px-1 py-0.5 -mx-1",
//             "hover:bg-sidebar-accent transition-all duration-150 active:scale-[0.98]",
//             pathname.startsWith("/profile") && "bg-sidebar-accent",
//           )}
//         >
//           <div className="relative shrink-0">
//             {profile.avatarUrl ? (
...
//         )}
//       >
//         {user?.avatar_url ? (  // ← was profile.avatarUrl
//           <img
//             src={user.avatar_url}
//             alt={initials}
//             className="w-7 h-7 rounded-full object-cover"
