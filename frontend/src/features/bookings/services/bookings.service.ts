...
// // //   currentUserId: string        = "",
// // // ): BookingSummary {
// // //   // ── FIX: sort ascending by date so [0] is always the nearest upcoming booking
// // //   const upcoming = [...current, ...future]
...
//     id:               raw.booking_id,
//     location:         raw.site_name      ?? "Office",
//     building:         raw.building_name  ?? "",         // ← added
//     floor:            raw.floor_name     ?? (raw.floor_id ? `Floor ${raw.floor_id}` : ""),
//     seat:             raw.seat_code      ?? raw.seat_id,
//     date:             raw.booking_date,
//     startTime:        raw.start_time     ?? "9:00 AM",
...
//   currentUserId: string        = "",
// ): BookingSummary {
//   // Sort ascending by date so [0] is always the nearest upcoming booking
//   const upcoming = [...current, ...future]
//     .filter((b) => b.status !== "cancelled")
//     .sort(
//       (a, b) =>
