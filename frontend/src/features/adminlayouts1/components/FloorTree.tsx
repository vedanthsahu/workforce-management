...
// FIX: memo() — prevents FloorTree from re-rendering when parent state changes
// (e.g. when LayoutTable updates its data). onSelect is stable via useCallback
// in FloorLayoutsPage so the memo comparison will hold.
