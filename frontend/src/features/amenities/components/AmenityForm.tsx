...
//   const inputClass =
//     "w-full h-9 px-3 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white";
...
//             className={`h-8 px-4 text-xs font-medium rounded-lg text-white ${
//               isFormValid
...
//                 className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white"
//               />
...
export default function AmenityForm() {
  ...
  if (newAmenityId) {
    router.push(
      `/admin/amenities?added=${newAmenityId}`
    );
  }
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className={inputClass}
              />
              <p className="text-xs text-gray-500 mt-1">Example: High Speed Wi-Fi</p>
            </div>
