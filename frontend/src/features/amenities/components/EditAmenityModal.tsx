  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      ...
      <div className="w-full max-w-4xl max-h-[90vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">Edit Amenity</h2>
            <p className="text-sm text-gray-500 mt-1">Update amenity details and save changes.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter amenity name"
              />
              <p className="text-xs text-gray-400 mt-2">Example: High Speed Wi-Fi</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-2">Select the most relevant category</p>
            </div>
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 px-8 py-5 border-t bg-gray-50">
          ...
          <button
            onClick={async () => {
              ...
              if (success) {
                // Pass the ID directly — no sessionStorage
