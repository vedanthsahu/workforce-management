...
export default function AmenitiesTable({ data, onEdit }: Props) {
  return (
    <table className="w-full text-sm table-auto">
      ...
      <thead className="text-xs text-gray-500 bg-gray-50 border-b sticky top-0 z-10">
        <tr>
          <th className="px-6 py-4 text-left">Amenity Name</th>
          <th className="px-6 py-4 text-left">Category</th>
          <th className="px-6 py-4 text-left">Description</th>
          <th className="px-6 py-4 text-center">Icon</th>
          <th className="px-6 py-4 text-center">Status</th>
          <th className="px-6 py-4 text-center">Assigned Seats</th>
      ...
      <tbody className="divide-y divide-gray-100">
        {data.map((amenity) => {
          ...
          return (
            <tr key={amenity.amenity_id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{amenity.amenity_key}</p>
                  </div>
                </div>
              </td>
              ...
              {/* DESCRIPTION */}
              <td className="px-6 py-4 text-gray-600 max-w-xs">{amenity.description}</td>
