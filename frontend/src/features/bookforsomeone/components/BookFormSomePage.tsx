...
// //     if (step === 2)
// //       canContinue =
// //         !!visitDetails.hostEmployee && !!visitDetails.visitDate && !!visitDetails.siteId && !!visitDetails.buildingId && !!visitDetails.floorId && !checkingEligibility;
...
// //               ? detail.message
// //               : "This guest already has an active booking for the selected date(s)."
// //           );
// //         } else {
...
// //             {eligibilityError && (
// //               <div className="mx-4 sm:mx-5 mt-3 bg-red-50 border border-red-200 rounded-xl px-4 sm:px-5 py-3 text-red-600 text-[12.5px] sm:text-[13px] flex items-start gap-3">
