...
//   // FIX: Prefetch add-amenity route on mount — button click is instant
//   useEffect(() => {
...
//       {/* FIX: Toaster at top level — never re-renders with filter/search state */}
//       <Toaster richColors position="top-right" />
...
//         {/* Prefetch on mount (useEffect above) + onMouseEnter as safety net */}
//         <button
