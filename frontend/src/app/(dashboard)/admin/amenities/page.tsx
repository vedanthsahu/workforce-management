...
// //   const [highlightedAmenityId, setHighlightedAmenityId] =
...
// //   if (id) {
// //     setHighlightedAmenityId(Number(id));

// //     setTimeout(() => {
// //       setHighlightedAmenityId(null);
...
//   const [highlightedAmenityId, setHighlightedAmenityId] = useState<number | null>(null);
//   const [pinnedAmenityId, setPinnedAmenityId] = useState<number | null>(null);
//   const [currentPage, setCurrentPage] = useState(1);

//   // Handle highlight from Add flow (via URL param ?added=ID)
//   useEffect(() => {
//     const addedId = searchParams.get("added");
//     if (addedId && data?.items?.length) {
//       const id = Number(addedId);
//       setPinnedAmenityId(id);
//       setHighlightedAmenityId(id);
...
//   const handleEditSuccess = (editedAmenityId: number) => {
//     fetchAmenities();
//     setPinnedAmenityId(editedAmenityId);
//     setHighlightedAmenityId(editedAmenityId);
...
//   // Pin the edited/added row to the top temporarily
//   const sortedAmenities = pinnedAmenityId
//     ? [
//         ...filteredAmenities.filter((a: any) => Number(a.amenity_id) === pinnedAmenityId),
//         ...filteredAmenities.filter((a: any) => Number(a.amenity_id) !== pinnedAmenityId),
//       ]
//     : filteredAmenities;
...
//           onSuccess={() => {
//             setOpenModal(false);
//             handleEditSuccess(selectedAmenity.amenity_id);
//           }}
//         />
//       )}
