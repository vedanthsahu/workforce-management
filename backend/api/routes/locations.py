...
def sites(
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("office:view")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def create_site_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("office:create")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def update_site_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("office:update")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def buildings(
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("building:view")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def create_building_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("building:create")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def update_building_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("building:update")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def floors_by_building(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("floor:view")),
    ],
...
def create_floor_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("floor:create")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def update_floor_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("floor:update")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def update_seat_configuration_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("layout_seat:update")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
...
def update_seats_bulk_configuration_route(
    ...
    current_user: Annotated[
        dict[str, Any],
        Depends(require_permission("layout_seat:bulk_update")),
    ],
    conn: Annotated[
        PGConnection,
        Depends(get_db),
